...
export default function Signup() {
  ...
  const onConnectClick = () => {
    history.push({
      ...
      state: { username: emailRef.current?.value, createdWithSuccess: true },
    });
  };
      ...
      <Row justifyContent="center" spacing="mb-2w">
        <Col spacing="m-auto">
          ...
          <Text as="p" spacing="mb-1w">
            Vous vous apprêtez à créer votre compte personnel. Cette étape est
      ...
      <Row spacing="mb-2w">
        <Col className={styles.resetFlexCol}>
          <Checkbox
            ...
            onChange={onChange}
            label="Je certifie avoir lu les"
            ref={cguRef}
          />
        </Col>
        <Col>
          <Text spacing="ml-1v" as="span">
            <Link
    ...
    <Container className={styles.centralContainerLarge} spacing="pt-10w">
      <Row justifyContent="center" spacing="mb-2w">
        <Col spacing="m-auto pr-2w">
          ...
          <Text as="p">
            👉 Ajouter hello@trackdechets.beta.gouv.fr à vos contacts
          </Text>
          <Text as="p">
